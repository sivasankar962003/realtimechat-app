...
<p className='text-gray-500'>{formatMessageTime(msg.createdAt)}</p>
  ...
  <div className='absolute bottom-0 left-0 right-0 flex items-center gap p-3'>
    ...
    <img onClick={handleSendMessage} src={assets.send_button} alt="" className='ps-2  cursor-pointer'/>
  </div>
        </div>
